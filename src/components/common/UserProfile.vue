  ...
  >
    ...
    <q-list>
      <q-item clickable v-close-popup @click="viewProfile">
        <q-item-section>
          <q-item-label class="user-name">{{ user?.name || 'User' }}</q-item-label>
          <q-item-label caption class="user-email">{{ user?.email || 'email@example.com' }}</q-item-label>
        </q-item-section>
      </q-item>
      ...
      <q-item clickable v-close-popup @click="viewSettings">
        <q-item-section avatar>
