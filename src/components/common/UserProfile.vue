<template>
  ...
  >
    ...
    <q-list class="dropdown-list min-w-[280px] max-w-[320px]">
      ...
      <div class="dropdown-header bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4">
        <div class="flex items-center space-x-3">
          ...
          <div class="flex-1 min-w-0">
            <h3 class="text-white font-semibold text-lg truncate" v-if="profile">
      ...
      <q-item v-if="loading" class="py-6">
        <q-item-section class="text-center">
          ...
          <q-item-label class="text-gray-600 mt-2">Loading profile...</q-item-label>
        </q-item-section>
      </q-item>
      ...
      <q-item v-else-if="error" class="py-4">
        <q-item-section class="text-center">
          ...
          <q-item-label caption class="text-red-500 mt-2">{{ error }}</q-item-label>
        </q-item-section>
      </q-item>
      ...
      <template v-else-if="profile">
        ...
        <div class="pb-2">
          ...
          >
            ...
            <q-item-section>
              <q-item-label class="font-medium text-red-700">Logout</q-item-label>
              <q-item-label caption class="text-red-500">Sign out of your account</q-item-label>
            </q-item-section>
          </q-item>
        </div>
      </template>
...
const getUserInitials = computed(() => {
  const name = profile.value?.name || profile.value?.full_name || user.value?.name || user.value?.email || 'User';
