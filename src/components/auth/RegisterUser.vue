				...
				<form
					...
					<div class="form-group">
						...
						<input
							...
							required />
						<div class="invalid-feedback" v-if="formSubmitted && !name">
					...
					<div class="form-group">
						...
						<div
							...
							v-if="formSubmitted && password.length < 8">
					...
					<div class="form-group">
						...
						<div
							class="invalid-feedback"
							v-if="formSubmitted && confirmPassword && !passwordsMatch">
					...
					<!-- Terms -->
					<div class="form-group d-flex align-items-center mb-3 checkbox-row">
						<input
							type="checkbox"
							id="terms"
							v-model="acceptTerms"
...
<style scoped>
	...
	.register-container {
		...
		overflow: visible; /* <-- yahan change karein */
	}
	...
	.form-control,
	select.form-control {
    background-position: right 2rem center; /* Arrow ko aur left karein */
}
	select.form-control {
		background-position: right 1.2rem center; /* Arrow ko andar karein */
	}
