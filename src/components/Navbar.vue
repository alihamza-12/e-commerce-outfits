...
<script setup>
	...
	function spinCart() {
		cartSpinning.value = true;
		setTimeout(() => {
			cartSpinning.value = false;
		}, 700);
	}
...
<style scoped>
	.navbar-root {
		...
		padding-bottom: 12px; /* Add this line for bottom padding */
	...
	.login-btn {
		display: inline-block;
		padding: 0.45rem 1.2rem; /* Smaller padding */
