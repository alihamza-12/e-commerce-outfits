<template>
	<div class="bg-gradient-to-br from-blue-50 to-pink-50 min-h-screen">
		<!-- Hero Section -->
		<section
			class="relative bg-white rounded-3xl shadow-xl mx-auto max-w-7xl mt-8 mb-12 overflow-hidden flex flex-col md:flex-row items-center">
			<div class="p-10 flex-1">
				...
				<p class="text-lg text-gray-600 mb-6">
					Explore our exclusive collection for Men, Women & Accessories. Fast
					delivery, easy returns, and best prices!
				</p>
				<div class="flex gap-4">
					...
					<router-link to="/men">
						<button
							class="bg-gray-100 text-blue-700 px-6 py-3 rounded-lg font-bold shadow hover:bg-blue-200 transition">
							Men's Collection
						</button>
					</router-link>
					<router-link to="/women">
						<button
							class="bg-pink-600 text-white px-6 py-3 rounded-lg font-bold shadow hover:bg-pink-700 transition">
							Women's Collection
						</button>
					</router-link>
				</div>
			...
			<div
				...
				<div
					...
					<div class="flex-1 flex flex-col">
						<h3 class="font-bold text-lg mb-1 text-gray-800 truncate">
							{{ product.name }}
						</h3>
		...
		<section class="max-w-2xl mx-auto px-4 mb-16">
			<div class="bg-white rounded-2xl shadow p-8 flex flex-col items-center">
				...
				<div v-if="newsletterMsg" class="mt-3 text-green-600 font-semibold">
					{{ newsletterMsg }}
				</div>
			</div>
		</section>
