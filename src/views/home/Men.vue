<template>
	<div class="bg-gradient-to-br from-blue-50 to-gray-100 min-h-screen py-8">
		<div class="container mx-auto px-4">
			...
			<div
				...
				<div>
					...
					<p class="text-gray-500 text-lg">
						Shop the latest in men's fashion: shirts, jeans, shoes, jackets,
						perfumes & more.
					</p>
				</div>
				<div class="flex gap-2">
					<input
						...
						class="border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 transition w-64 shadow-sm" />
					<button
						class="bg-white border border-gray-300 rounded-lg px-4 py-2 hover:bg-blue-50 transition"
						@click="clearSearch"
						v-if="searchQuery">
						Clear
					</button>
			...
			<div
				...
				class="text-center text-gray-400 py-20 text-xl">
				No products found.
			</div>
			<div
				v-else
				...
				<div
					...
					<div class="flex-1 flex flex-col">
						<h2 class="font-bold text-lg mb-1 text-gray-800 truncate">
							{{ product.name }}
						</h2>
			...
			<transition name="fade">
				<div
					...
					<div
						class="bg-white p-8 rounded-2xl w-full max-w-md relative shadow-2xl">
						<button
						...
						<span class="text-blue-600 font-extrabold text-xl block mb-4"
...
<style scoped>
	.filter-select {
		@apply border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 transition shadow-sm;
		min-width: 150px;
	}
	.fade-enter-active,
	.fade-leave-active {
